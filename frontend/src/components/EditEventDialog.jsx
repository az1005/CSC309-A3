...
const EditEventDialog = ({ open, onClose }) => {
    const { updateMessage, setUpdateMessage, updateEvent, singleEvent, statusChange, setStatusChange } = useEvent();
    ...
    const [updateData, setUpdateData] = useState({
        ...
        points: singleEvent?.pointsRemain || 0,
        published: singleEvent?.published || false,
    });
                    ...
                    <Grid container spacing={2} sx={{ mt: 2 }}>
                        ...
                        <Grid>
                            <TextField
                                ...
                                helperText={fieldErrors.points}
                            />
                        </Grid>

                        {/* published checkbox: place in one column */}
                        <Grid item xs={6}>
                            <FormControl error={Boolean(fieldErrors.published)}>
                                <FormControlLabel
                                    control={
                                        <Checkbox
                                            name="published"
                                            ...
                                            onChange={handleChange}
                                            disabled={updateData.published}
                                        />
                                    }
                                    label="Published"
                                />
                                {fieldErrors.published && (
                                    <FormHelperText>{fieldErrors.published}</FormHelperText>
                                )}
                            </FormControl>
                        </Grid>
